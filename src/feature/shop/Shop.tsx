import { ArrowRight, Grid3X3, List, ShoppingCart, Star } from "lucide-react";
...
const Shop = () => {
  return (
    <div>
      <div className="rounded-2xl mx-4 lg:mx-auto max-w-7xl mt-6 space-y-3">
        <Image
        ...
        {/* Products search */}
        <div className="bg-white rounded-lg shadow-sm p-4 mb-6 mt-5">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center gap-2 text-sm text-gray-600">
              ...
              <span>Shop Page</span>
              <span>/</span>
              <span className="text-green-600">24 Products</span>
            </div>
